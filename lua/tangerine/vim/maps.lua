...
local _local_1_ = env.get("mapping")
...
local function nmap_21(lhs, rhs)
  _G.assert((nil ~= rhs), "Missing argument rhs on fnl/tangerine/vim/maps.fnl:15")
  _G.assert((nil ~= lhs), "Missing argument lhs on fnl/tangerine/vim/maps.fnl:15")
