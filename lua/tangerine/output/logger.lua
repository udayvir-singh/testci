...
local function empty_3f(list)
  _G.assert((nil ~= list), "Missing argument list on fnl/tangerine/output/logger.fnl:15")
...
local function indent(str, level)
  _G.assert((nil ~= level), "Missing argument level on fnl/tangerine/output/logger.fnl:23")
  _G.assert((nil ~= str), "Missing argument str on fnl/tangerine/output/logger.fnl:23")
  local spaces = ""
  for _ = 1, level do
    spaces = (spaces .. " ")
  end
