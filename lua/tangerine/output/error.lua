...
err.send = function(line, msg, virtual_3f)
  _G.assert((nil ~= virtual_3f), "Missing argument virtual? on fnl/tangerine/output/error.fnl:49")
  ...
  vim.diagnostic.set(nspace, buffer, {{lnum = line, col = 0, end_col = -1, severity = vim.diagnostic.severity.ERROR, source = "tangerine", message = msg}}, _2_())
...
err.handle = function(msg, opts)
  _G.assert((nil ~= opts), "Missing argument opts on fnl/tangerine/output/error.fnl:86")
