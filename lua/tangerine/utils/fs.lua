...
fs.read = function(path)
  _G.assert((nil ~= path), "Missing argument path on fnl/tangerine/utils/fs.fnl:15")
...
fs.write = function(path, content)
  _G.assert((nil ~= content), "Missing argument content on fnl/tangerine/utils/fs.fnl:19")
  _G.assert((nil ~= path), "Missing argument path on fnl/tangerine/utils/fs.fnl:19")
...
fs.remove = function(path)
  _G.assert((nil ~= path), "Missing argument path on fnl/tangerine/utils/fs.fnl:26")
